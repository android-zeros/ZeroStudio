 ...
 * @author android_zero
 * 
 * AGP 9.0 UPG: New implementation for the PrivacySandboxSdkInfo interface.
 * This class models the build information for Privacy Sandbox SDKs.
 */
data class DefaultPrivacySandboxSdkInfo(
