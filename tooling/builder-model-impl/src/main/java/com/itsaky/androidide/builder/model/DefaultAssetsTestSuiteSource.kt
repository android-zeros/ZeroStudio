 ...
 * @author android_zero
 * 
 * AGP 9.0 UPG: New implementation for the AssetsTestSuiteSource interface.
 * Represents the asset sources for a test suite.
 */
data class DefaultAssetsTestSuiteSource(
    override val name: String,
    override val directories: Collection<File>
) : AssetsTestSuiteSource, Serializable {
