...
/**
   * Executes tests with fine-grained control.
   *
   * @param message The message defining which tests to run and how.
   * @return A CompletableFuture which completes with the result of the test execution.
   */
  @JsonRequest
  fun executeTests(message: TestExecutionMessage): CompletableFuture<TaskExecutionResult>
