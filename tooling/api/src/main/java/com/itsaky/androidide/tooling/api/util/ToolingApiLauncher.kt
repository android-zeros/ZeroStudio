...
import com.itsaky.androidide.builder.model.DefaultTestSuiteArtifact
 ...
 * @author android_zero
 * 
 * AGP 9.0 UPG: Added `TestSuiteArtifact` to the Gson type adapter configuration
 * to support the new test suite models.
 */
object ToolingApiLauncher {
  ...
  fun configureGson(builder: GsonBuilder) {
    ...
    builder.runtimeTypeAdapter(
        TestSuiteArtifact::class.java,
        DefaultTestSuiteArtifact::class.java
    )
    builder.runtimeTypeAdapter(
