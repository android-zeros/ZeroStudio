...
// import android.zero.studio.lsp4j.LspModule
...
class ProjectManagerImpl : IProjectManager, EventReceiver {
  ...
  // LSP INTEGRATION: Shutdown existing LSP instance before opening a new project.
        // LspModule.shutdown()
  ...
  override fun destroy() {
    ...
    // LSP INTEGRATION: Ensure LSP services are shut down when the project manager is destroyed.
        // LspModule.shutdown()
